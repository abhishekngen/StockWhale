...
public class Queen extends Piece {
    ...
    public ArrayList<String> getPossibleMoves(String originalcoord, boolean isWhitePlaying) {
        ...
        //Iterates through 8 possible lines of movement of queen piece - vertically upwards, downwards, horizontally to the right, to the left, and diagonally upwards to the right and left and diagonally downwards to right and left
